...
const Join = () => {
  ...
  return (
    <Container>
      <CheckBox id="termAll">이용약관 전체 동의하기</CheckBox>
      <HorizontalLine color={"#EAEAEA"} marginHorizontal={30} />
      <Section gap={16} direction="column">
        <CheckBox id="term1">서비스 이용약관 (필수)</CheckBox>
        <CheckBox id="term2">개인정보 수집 및 이용 동의 (필수)</CheckBox>
      </Section>
      <HorizontalBlank height={34} />
      <Button onClick={() => router.push(ROUTES.JOIN_STEP.url)}>
        가입하기
      </Button>
    </Container>
  );
